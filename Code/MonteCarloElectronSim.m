function [avgVelocityX, t_vec] = MonteCarloElectronSim(BottleNeck, DiffuseCollisions, ParticleScattering, FieldType, bottleNeckStartX, bottleNeckStartY, bottleneckWidth, bottleneckLength)
