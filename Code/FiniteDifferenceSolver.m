function [currentLeft, currentRight, Ex, Ey] = FiniteDifferenceSolver(backgroundCond, boxCond, doPlot, bottleNeckStartX, bottleNeckStartY, bottleneckLength, bottleneckWidth)
